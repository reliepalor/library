...
<body class="bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white/80 backdrop-blur-lg rounded-xl shadow-lg p-6 border border-green-200/40">
                <div class="flex items-center justify-between">
                    <div>
            ...
            <div class="bg-white/80 backdrop-blur-lg rounded-xl shadow-lg p-6 border border-yellow-200/40">
                <div class="flex items-center justify-between">
                    <div>
            ...
            <div class="bg-white/80 backdrop-blur-lg rounded-xl shadow-lg p-6 border border-purple-200/40">
                <div class="flex items-center justify-between">
                    <div>
        ...
        <!-- Filters and Search -->
        <div class="bg-white/80 backdrop-blur-lg rounded-xl shadow-lg p-6 mb-8 border border-blue-200/40">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
                <div class="flex flex-col sm:flex-row sm:items-center space-y-4 sm:space-y-0 sm:space-x-4">
                    ...
                    <!-- Category Filter -->
                    <select class="w-full sm:w-48 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    ...
                    <!-- Status Filter -->
                    <select class="w-full sm:w-32 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50/50 transition-colors duration-200">
                                ...
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-12 w-12">
                                        @if($newsItem->featured_image)
                                            <img class="h-12 w-12 rounded-lg object-cover" src="{{ asset('storage/' . $newsItem->featured_image) }}" alt="">
                                        @else
                                            <div class="h-12 w-12 rounded-lg bg-gradient-to-br from-blue-100 to-purple-100 flex items-center justify-center">
                                                <svg class="h-6 w-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div class="ml-4">
                                        <div class="flex items-center">
                                            <h3 class="text-sm font-medium text-gray-900">{{ Str::limit($newsItem->title, 50) }}</h3>
                                        ...
                                        <p class="text-sm text-gray-500">{{ Str::limit($newsItem->excerpt ?: strip_tags($newsItem->content), 80) }}</p>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ match($newsItem->category) {
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ match($newsItem->status) {
