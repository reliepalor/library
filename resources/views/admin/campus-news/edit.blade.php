...
<body class="bg-gray-50">
    ...
    <div class="transition-all duration-500 ease-in-out"
        ...
        x-data="{ sidebarExpanded: $persist(true) }"
        @sidebar-changed.window="sidebarExpanded = $event.detail.expanded">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text"
                                id="meta_title"
                                name="meta_title"
                                value="{{ old('meta_title', $campusNews->meta_title) }}"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="meta_description"
                                    ...
                                    rows="3"
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                                    placeholder="Brief description for search engines...">{{ old('meta_description', $campusNews->meta_description) }}</textarea>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text"
                                id="tags"
                                name="tags"
                                value="{{ old('tags', $campusNews->tags) }}"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
