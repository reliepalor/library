                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Teacher/Visitor ID</th>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200" id="attendance-table-body">
                                    @forelse($todayAttendance as $attendance)
                                        <tr data-attendance-id="{{ $attendance['id'] }}">
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $attendance['teacher_visitor_id'] }}</td>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                <div class="flex flex-col space-y-1">
                                                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-50 text-blue-700">{{ $attendance['department'] }}</span>
                                                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-50 text-green-700">{{ $attendance['role'] }}</span>
                                                </div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
